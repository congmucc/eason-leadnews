...
CREATE TABLE `wm_material`  (
  ...
  `created_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 81 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '自媒体图文素材信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `wm_material` VALUES (72, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/9bab7cbdae074242bb8b6d3c938be89d.jpg', 0, 0, '2024-01-18 00:17:38');
INSERT INTO `wm_material` VALUES (73, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/7a0edac8a56b44f7b9a84c458e6c6c5c.jpg', 0, 0, '2024-01-18 00:17:46');
INSERT INTO `wm_material` VALUES (74, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/9de93e576934496dafbcff7c5c7d9684.jpg', 0, 0, '2024-01-18 00:20:26');
INSERT INTO `wm_material` VALUES (75, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/688e38f792604362b6a8341424f03036.jpg', 0, 0, '2024-01-18 23:34:44');
INSERT INTO `wm_material` VALUES (76, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/eef6b8a50181422288779905aeb8a14a.jpeg', 0, 0, '2024-01-18 23:34:52');
INSERT INTO `wm_material` VALUES (77, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/c392229f9095455b90bf6013db8ac873.jpg', 0, 0, '2024-01-18 23:35:08');
INSERT INTO `wm_material` VALUES (78, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/d4184acfeba34aa89c0d5dcadda67770.jpg', 0, 0, '2024-01-18 23:35:20');
INSERT INTO `wm_material` VALUES (79, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/a969ad0ac87f46718a588e2cb9d79ecd.jpg', 0, 0, '2024-01-18 23:35:20');
INSERT INTO `wm_material` VALUES (80, 1102, 'http://192.168.47.128:9000/leadnews/2024/01/18/a89595d836da43eea5fa55fe0d04311b.jpg', 0, 0, '2024-01-18 23:35:21');
...
CREATE TABLE `wm_news`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6236 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '自媒体图文内容信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `wm_news` VALUES (6232, 1102, '测试文章1', '[{\"type\":\"text\",\"value\":\"测试内容\\n\"},{\"type\":\"image\",\"value\":\"http://192.168.47.128:9000/leadnews/2024/01/18/eef6b8a50181422288779905aeb8a14a.jpeg\"},{\"type\":\"image\",\"value\":\"http://192.168.47.128:9000/leadnews/2024/01/18/a89595d836da43eea5fa55fe0d04311b.jpg\"},{\"type\":\"text\",\"value\":\"请在这里输入正文\"}]', 1, 1, 'java', '2024-01-18 23:39:09', '2024-01-18 23:39:09', 9, '2024-01-18 23:39:07', '审核成功', 1750392006837932033, 'http://192.168.47.128:9000/leadnews/2024/01/18/c392229f9095455b90bf6013db8ac873.jpg', 1);
INSERT INTO `wm_news` VALUES (6233, 1102, '测试文章2', '[{\"type\":\"text\",\"value\":\"12342134\"},{\"type\":\"image\",\"value\":\"http://192.168.47.128:9000/leadnews/2024/01/18/a89595d836da43eea5fa55fe0d04311b.jpg\"},{\"type\":\"text\",\"value\":\"请在这里输入正文\"}]', 1, 2, '七二', '2024-01-25 19:56:50', '2024-01-25 19:56:50', 1, '2024-01-25 12:00:00', NULL, NULL, 'http://192.168.47.128:9000/leadnews/2024/01/18/a89595d836da43eea5fa55fe0d04311b.jpg', 1);
INSERT INTO `wm_news` VALUES (6234, 1102, '测试文章3', '[{\"type\":\"image\",\"value\":\"http://192.168.47.128:9000/leadnews/2024/01/18/c392229f9095455b90bf6013db8ac873.jpg\"},{\"type\":\"text\",\"value\":\"请在这里输入正文\"}]', 1, 6, '大数据', '2024-01-25 20:50:49', '2024-01-25 20:50:49', 9, '2024-01-25 20:50:47', '审核成功', 1750501476230369281, 'http://192.168.47.128:9000/leadnews/2024/01/18/eef6b8a50181422288779905aeb8a14a.jpeg', 1);
INSERT INTO `wm_news` VALUES (6235, 1102, '第五天测试文章', '[{\"type\":\"text\",\"value\":\"第五天测试文章，这里是正文\\n\"},{\"type\":\"text\",\"value\":\"请在这里输入正文\"}]', 0, 2, '1324', '2024-02-04 22:19:20', '2024-02-04 22:19:20', 9, '2024-02-04 22:19:15', '审核成功', 1754147632898510850, NULL, 1);
...
CREATE TABLE `wm_news_material`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 287 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '自媒体图文引用素材信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `wm_news_material` VALUES (281, 76, 6232, 1, 0);
INSERT INTO `wm_news_material` VALUES (282, 80, 6232, 1, 1);
INSERT INTO `wm_news_material` VALUES (283, 80, 6233, 1, 0);
INSERT INTO `wm_news_material` VALUES (284, 80, 6233, 1, 0);
INSERT INTO `wm_news_material` VALUES (285, 77, 6234, 1, 0);
INSERT INTO `wm_news_material` VALUES (286, 76, 6234, 1, 0);
